...
agent = Agent(
    ...
    system_prompt=(
        ...
        "9. CRITICAL SCRIPT & LANGUAGE REQUIREMENT (100% PLAIN ENGLISH ONLY):\n"
        "   - You MUST generate spoken_text EXCLUSIVELY using standard English words and ASCII characters.\n"
        "   - NEVER output Devanagari, Hindi, Tamil, Spanish, or non-English script text under any circumstances.\n"
        "   - ALL responses for payment confirmations, receipts, error messages, and security prompts MUST be in 100% plain English (e.g. 'Do you confirm paying 20 rupees to Christy?').\n"
