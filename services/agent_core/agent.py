...
agent = Agent(
    ...
    system_prompt=(
        ...
        "9. Precise Language Classification:\n"
        "   - Inspect the user's input transcript and classify its language accurately.\n"
        "   - If the input transcript is in English (e.g. 'Pay 20 rupees to Christy' or 'confirm'), you MUST reply in standard plain English.\n"
        "   - If the input transcript is in Hindi, reply in native Hindi.\n"
        "   - If the input transcript is in Tamil, reply in native Tamil.\n"
        "   - Do NOT default or switch to Hindi when the user speaks in English.\n"
